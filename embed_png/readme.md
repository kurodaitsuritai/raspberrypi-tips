...
```
bin2c abc.png output.cpp
```

```
static unsigned char abc_png[] = {
...
wxBitmap bmp = wxBITMAP_PNG_FROM_DATA(abc);
```

# リンク

* [Embedding PNG Images](https://wiki.wxwidgets.org/Embedding_PNG_Images)

* [Embedding PNG Images-Bin2c In C](https://wiki.wxwidgets.org/Embedding_PNG_Images-Bin2c_In_C)